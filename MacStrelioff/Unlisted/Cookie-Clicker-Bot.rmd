...
# This is a draft / still being written

## TODO:
- look into class inheritance, to make the other two classes simpler to implement / help with cleaner code
- rename variables in naive class to be consistent with others (epochs for balance and revenue)
- run again without upgrades
- track start/end time, and log based on time instead of clicks.
