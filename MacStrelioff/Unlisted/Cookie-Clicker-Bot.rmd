...
The game has other mechanics (upgrades, ascension, golden cookies, ...). I programed functions to purchase upgrades and click golden cookies, but these functions were disabled in the analyses below to allow for a controlled comparison of the algorithms, which only differed in their strategy for building purchases.
