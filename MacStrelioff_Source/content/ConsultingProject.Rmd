...
Since the primary goal focused on behavior during the free-trial, I excluded any users who were never on a free trial during the data collection period. 
...
![Distribution of cumulative workspaces created per user, split by those who ever paid (blue) and those that were on a free trial forever (red)](csum_files_per_contributor.png)
<!---
