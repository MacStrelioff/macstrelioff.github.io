...
I visualized the data using boxplots split by converters vs non converters, across days. 
...
![Mean (bar length) and standard deviation (black error bars) of feature importance evaluated across the 5 folds.](rf_feature_importance.png)
