...
for count in range(100000):
    b[count] = rand7(11)
_= plt.hist(b) # not prettified, but this is for test only
Counter(b)
```
...
Questions around current / previous experience and education. Important metrics to think of in relation to LinkedIn data, to be included in dashboards available to executive level. Questions around SQL, R, and Python.  
