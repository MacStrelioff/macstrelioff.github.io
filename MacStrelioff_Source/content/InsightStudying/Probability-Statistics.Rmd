...
- A variable $Z$ influences the treatment $X$, and is also correlated with the error terms $e$.
- This introduces bias in $\hat{\beta}_{OLS}$.
- 
...
- $z$ is measured so that it can be included in the model. 
