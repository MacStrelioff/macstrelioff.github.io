...
- A variable $Z$ influences the treatment $X$, but does not have a direct effect on the outcome $Y$. 
- e.g. Treatment assignemnt $Z$ can influence the actual treatment $X$, and $Z$ might be influenced by variables that are associated with $Y$ such as comorbidities. 
- 


Assumptions and Requirements:

- The IV is correlated with X but not with the error term
