...
- Just expressions of dependenc between random variables
...
This assumption allows the use of propensity scores $\hat{p}(W_i|X_i)$, which are estimates of $p(W_i|X_i)$ that are used to match participants with similar propensity, or to reweight observed outcomes to account for propensity. 
