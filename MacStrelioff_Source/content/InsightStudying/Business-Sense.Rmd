...
Note that the choice of metrics determines what the platform is being optimized for. So think about what will happen if the platform is optimized for the chosen metric?
