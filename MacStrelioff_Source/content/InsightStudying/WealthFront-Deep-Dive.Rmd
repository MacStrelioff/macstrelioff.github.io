...
- Plans to roll out credit cards? 
...
- ** I love the vision of self-driving money, this kind of automation is something I's want to build for myself if I had the time. 
...
- What is your like 'methods stack', so what kind of statistical methods or frameworks do you use often? 
- Frequentist, Bayesian, Causal inference (methods for addressing violations of true randomization e.g. early adopters, )
