...
- - Primarily an income investor
- - replicated XIV
- - Quantopian had a bug in dividends paid, so I submitted a ticket showing this with AAPL stock, and stopped using that platform..
...
- Debated friends about whether buying or renting is better, I liked WealthFront's analysis on this topic (though it leaves out the tax benefits of buying?)
- I also like the principled investment philosophy (Modern protfolio theory, accounting for taxes, ... )

<!-- Quantopian investment philosophy -->

- I'm proimarily an income investor
- Dividends reflect the risk in a stock, so I wanted to make a portfolio of dividend paying stocks weighted invesely proportional to the dividend yield.
- Quantopian dividend data had a bug, so I gave up on this for now..

<!-- fit for growth team -->

- YT channel, casually testing thumbnails
- HaaS work on fb ads and google analytics (talk about these tools)
- Insight work on modeling uswe conversion for a free-trial to subscriber

<!-- Questions / Interest -->

- Which team are you on?
- Interested in the financial problems addressed; 
- e.g. [right considerations for buying vs renting](https://www.wealthfront.com/home-guide#buy-versus-rent), plus tax implications

<!-- Value adds / ideas-->

- Why would I use Wealthfront? 
- Why would I switch from savings to their portfolio management?
...
TODO: think of a causal inference example related to an experiment here, to duscuss intelligently in the phone interview!!
