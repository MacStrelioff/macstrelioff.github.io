...
- go to html code, ask dennis to do it for you....... 
- or google it lol
- green or blue because they contrast both the notmal youtube and the darkmode youtube
...
- instead of 'part 1, ..' find seperate videos that can rank on their own.
- videos with individual titles to funnel people in, then 
- have one keyword (different from tags).
...
- 6-8 tags -- target keyword should be first tag, next 4 tags should be long tailed versions
- most important for keyword is title. 
